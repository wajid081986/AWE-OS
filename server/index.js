...
app.use('/api/admin/video-agent/generate', (req, res, next) => { req.setTimeout(300_000); res.setTimeout(300_000); next(); });
app.use('/api/admin/video-agent', adminLimiter, adminVideoAgentRoutes);
