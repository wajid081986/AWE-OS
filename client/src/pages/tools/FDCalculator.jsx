...
export default function FDCalculator() {
  ...
  const SEO_TITLE = 'FD Calculator — Fixed Deposit & RD Calculator India | AWE-OS'
  const SEO_DESC  = 'Calculate FD maturity amount, TDS on interest, and compare FD rates across SBI, HDFC, ICICI, Axis, Kotak, and Post Office. Free online FD & RD calculator.'
  const SEO_URL   = 'https://www.awe-os.com/tools/fd-calculator'
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords"           content="fd calculator, fixed deposit calculator india, rd calculator, sbi fd calculator, hdfc fd calculator, tds on fd, fd interest calculator" />
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          name: 'FD Calculator', url: SEO_URL,
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-800 to-gray-900">
        ...
        <div className="border-b border-white/10 bg-black/20 backdrop-blur-sm">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 flex items-center gap-2 text-xs text-gray-400">
            ...
            <span>/</span>
            <span className="text-gray-300">FD Calculator</span>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-10 space-y-6">
          ...
          <div className="text-center">
            <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/30 rounded-full px-4 py-1.5 text-xs text-blue-300 font-medium mb-4">
              <span className="w-1.5 h-1.5 rounded-full bg-blue-400 animate-pulse" />
              Indian Bank FD &amp; RD Calculator
            </div>
            <h1 className="text-3xl sm:text-4xl font-bold text-white mb-3 tracking-tight">FD Calculator</h1>
            <p className="text-gray-400 text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
              Calculate Fixed Deposit and Recurring Deposit returns, TDS on interest, and compare rates across
              SBI, HDFC, ICICI, Axis, Kotak, and Post Office.
            </p>
            ...
            <div className="space-y-2">
              {FAQS.map((faq, i) => (
                <div key={i} className="border border-white/10 rounded-xl overflow-hidden">
                  ...
                  >
                    <span className="text-xs font-medium text-gray-200 pr-4">{faq.q}</span>
                    <span className={`text-gray-500 shrink-0 transition-transform ${openFaq === i ? 'rotate-180' : ''}`}>
                      &#8964;
                    </span>
                  </button>
                  {openFaq === i && (
