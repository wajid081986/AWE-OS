...
import DecisionModal from '../dashboard/DecisionModal';

const AutonomousPanel   = lazy(() => import('../dashboard/AutonomousPanel'));
const BuilderPanel      = lazy(() => import('../dashboard/BuilderPanel'));
const CodeViewer        = lazy(() => import('../dashboard/CodeViewer'));
const DeploymentPanel   = lazy(() => import('../dashboard/DeploymentPanel'));
const IdeaPanel         = lazy(() => import('../dashboard/IdeaPanel'));
const MarketingPanel    = lazy(() => import('../dashboard/MarketingPanel'));
const MonetizationPanel = lazy(() => import('../dashboard/MonetizationPanel'));
const RevenuePanel      = lazy(() => import('../dashboard/RevenuePanel'));
const SupportPanel      = lazy(() => import('../dashboard/SupportPanel'));
  ...
  return (
    <div style={S.page}>
      ...
      <header style={S.header}>
        <div>
          <h1 style={S.h1}>⚙️ AWE-OS Admin Panel</h1>
          <p style={S.subtitle}>System management & analytics</p>
        </div>
        <div style={{ display: 'flex', gap: '10px', alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          <a href="/dashboard" style={{ ...S.btnGhost, textDecoration: 'none', display: 'inline-flex', alignItems: 'center' }}>
            ← User Dashboard
          </a>
        </div>
      </header>
...
class PanelErrorBoundary extends React.Component {
  ...
  componentDidCatch(error, info) {
    console.error(`[AdminDashboard] ${this.props.name} panel error:`, error, info.componentStack);
  }
  render() {
