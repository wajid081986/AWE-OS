...
export const TOOL_ABOUT = {
  ...
  'pdf-editor': {
  "description": "AWE-OS PDF Editor is an indispensable free tool tailored for Indian users who need to manage their PDF documents with ease and security. As businesses and educational institutions in India increasingly adopt digital documentation, the need for reliable editing tools has never been greater. Whether you're a student reviewing lecture notes, a small business owner drafting invoices, or a government official handling sensitive documents, our browser-based PDF editor enables you to edit, annotate, and sign PDFs seamlessly. Best of all, you can do this without the concern of exposing sensitive information to external servers, making it a perfect fit for the privacy-conscious Indian user.",
  "features": [
    "User-friendly interface: Navigate effortlessly through our intuitive design, making PDF editing accessible for everyone, regardless of tech-savviness.",
    "Real-time collaboration: Work together with colleagues or classmates on the same document simultaneously, enhancing teamwork and productivity.",
    "Secure document handling: Edit your PDFs without uploading them to external servers, ensuring your sensitive information remains private and secure.",
    "Comprehensive annotation tools: Highlight, underline, and add comments or notes to your documents, making it easy to review and share feedback.",
    "E-signature capabilities: Easily sign your PDFs electronically, streamlining the approval process for contracts and agreements, which is essential for businesses dealing with GST invoices.",
    "Multi-format support: Import and export PDFs with various formats, allowing you to convert documents as needed for presentations or reports."
  ],
  "useCases": [
    "As a student in India, you can use AWE-OS PDF Editor to annotate your lecture notes and share them with classmates, ensuring everyone has access to the same information without the hassle of printed materials.",
    "Small business owners can efficiently draft and sign contracts or invoices, ensuring compliance with GST regulations while saving time and money by avoiding printing and mailing.",
    "A government employee managing departmental documents can utilize our editor to easily update forms or reports, ensuring that all changes are captured without needing to start from scratch.",
    "Freelancers can use this tool to create polished proposals and contracts for clients, enhancing professionalism and making the process smoother with built-in e-signature functionality."
  ],
  "howToUse": [
    "Step 1: Visit the AWE-OS PDF Editor website and select 'Start Editing' to access the editor without any downloads.",
    "Step 2: Upload your PDF document directly from your computer or drag and drop it into the editor.",
    "Step 3: Use the available tools to annotate, highlight, or edit text within the PDF as needed.",
    "Step 4: Once your edits are complete, save the document directly to your device or share it via email or other platforms.",
    "Step 5: For documents requiring signatures, use our e-signature feature to sign and send the document securely."
  ],
  "whyUseUs": [
    "Our PDF Editor is completely free, meaning Indian users can access high-quality editing tools without the burden of subscription fees or hidden costs, making it budget-friendly for students and small businesses alike.",
    "We prioritize user privacy by not requiring uploads to external servers, allowing you to handle sensitive information securely, which is crucial for maintaining confidentiality in business and personal matters.",
    "With a focus on the Indian context, our tools are designed to cater to local needs, including compliance with GST regulations, ensuring users can manage their documents effectively within the legal framework."
  ],
  "faqs": [
    {
      "q": "Is AWE-OS PDF Editor really free to use?",
      "a": "Yes, AWE-OS PDF Editor is completely free for all users. There are no hidden charges or subscription fees, making it an ideal choice for Indian students, freelancers, and small businesses looking to manage their PDF documents without financial strain."
    },
    {
      "q": "Can I use this tool for sensitive documents?",
      "a": "Absolutely! AWE-OS PDF Editor allows you to edit and annotate documents without uploading them to any server. This means your sensitive information remains secure, making it suitable for handling personal, business, or government documents."
    },
    {
      "q": "What types of documents can I create or edit with this tool?",
      "a": "You can create or edit a variety of document types including contracts, invoices, lecture notes, and reports. Our PDF Editor supports various formats, allowing you to convert files as necessary for your specific needs, especially for compliance with GST or other Indian regulations."
    }
  ]
},
  ...
  'unlock-pdf': {
  "description": "AWE-OS Unlock PDF is a user-friendly tool specifically designed for Indian users to easily remove password protection from their PDF documents. Whether you have bank statements, salary slips, or any other important documents secured with a password, our free tool enables you to unlock them without hassle. This is particularly useful for individuals who frequently deal with financial documents where passwords often hinder accessibility. By unlocking your PDFs, you can ensure smoother access and management of your essential documents, saving you time and effort.",
  "features": [
    "User-friendly interface that simplifies the unlocking process for everyone, regardless of technical skills.",
    "No installation required; access the tool directly from your browser for instant unlocking.",
    "Supports various types of PDF files, allowing you to unlock a wide range of documents including bank statements and invoices.",
    "Secure processing that ensures your files are not stored or shared after unlocking, maintaining your privacy.",
    "Fast processing time, allowing you to unlock documents in seconds, ideal for busy professionals.",
    "Free to use with no hidden charges, making it accessible for all users in India."
  ],
  "useCases": [
    "If you're a salaried professional in India, you often receive your salary slip in a password-protected PDF. Unlocking it allows you to easily share it with banks or loan providers without the hassle of entering passwords repeatedly.",
    "Small business owners frequently receive invoices in PDF format from vendors. Using our tool, they can unlock these documents for easy accounting and record-keeping without any password issues, facilitating smoother business operations.",
    "Students may receive their academic documents or certificates as password-protected PDFs. Unlocking these files allows them to submit necessary documents for applications without the inconvenience of password entry.",
    "Freelancers in India often sign contracts that come as secured PDFs. By using our tool, they can unlock these contracts for easy printing and sharing with clients or for personal records."
  ],
  "howToUse": [
    "Step 1: Click on 'Select PDF' or drag your password-protected PDF file into the designated area on the AWE-OS Unlock PDF website.",
    "Step 2: Enter the current password that unlocks the document. Make sure to input it accurately to avoid errors.",
    "Step 3: Click on the 'Unlock' button to initiate the unlocking process.",
    "Step 4: Wait for a few moments as our tool processes your request. You will be notified once the process is complete.",
    "Step 5: Download the unlocked PDF to your device and enjoy unrestricted access."
  ],
  "whyUseUs": [
    "Our tool is specifically designed for Indian users, addressing common issues faced with password-protected PDFs in the local context, such as financial documents and government forms.",
    "We prioritize user privacy and security; your documents are not stored on our servers, ensuring no unauthorized access to your sensitive information.",
    "AWE-OS Unlock PDF is completely free, providing an essential service without any charges, making it a cost-effective solution for individuals and businesses alike."
  ],
  "faqs": [
    {
      "q": "Is it safe to use AWE-OS Unlock PDF?",
      "a": "Yes, AWE-OS Unlock PDF is completely safe to use. We do not store any of your files after processing, ensuring your documents remain confidential. Additionally, our service uses secure connections to protect your data during the unlocking process."
    },
    {
      "q": "What types of PDF files can I unlock?",
      "a": "You can unlock various types of PDF files, including those containing financial documents like bank statements, salary slips, and invoices. As long as you know the password, our tool can help you unlock these documents for easier access."
    },
    {
      "q": "Do I need to download any software to use the tool?",
      "a": "No, there is no need to download any software. AWE-OS Unlock PDF is a web-based tool that you can access directly from your browser. This makes it convenient and accessible from any device, whether you are using a computer or a smartphone."
    }
  ]
},
  ...
  'resume-builder': {
    ...
    whyUseUs: [
      ...
      "No watermark on your downloaded resume, and no forced monthly subscription — most paid resume builders charge ₹500 to ₹2,000 per PDF download or lock you into a plan; AWE-OS Resume Builder uses simple pay-per-use pricing, with an optional Pro plan for frequent use",
  ...
  'ai-content-writer': {
    ...
    whyUseUs: [
      ...
      "Simple pay-per-use pricing with no forced monthly subscription — commercial AI writing tools like Jasper, Copy.ai, and Writesonic charge ₹2,000 to ₹10,000 per month regardless of usage; AWE-OS lets you pay only when you generate content, or choose an optional Pro plan for frequent use",
