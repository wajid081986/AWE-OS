...
export const BLOG_POSTS = [
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    content: [
      ...
      { type: 'h2', text: 'A Few More Worth Bookmarking' },
      { type: 'ul', items: [
        'Word Counter — paste any text to see word count, character count, and estimated reading time instantly; useful for staying within essay word limits',
        'Password Generator — create strong, unique passwords for every university account; reused passwords are the most common cause of student account breaches',
        'Color Picker — get HEX, RGB, and HSL values for any colour; useful for design and web development coursework',
        'Image Compressor — shrink image file sizes for assignment uploads and portfolio sites without visibly losing quality',
      ]},
      { type: 'h2', text: 'Why Browser-Based Tools Beat Installed Apps' },
      { type: 'p', text: "Downloaded apps take up storage, need regular updates, and sometimes ask for a subscription. Browser-based tools work on any device — a university lab computer, your phone, a friend's laptop in the library — with nothing to install and no account to create. Bookmark the ones you use most and they're one tap away, without adding another single-purpose app to your phone." },
      ...
      { type: 'ul', items: [
        ...
        'Word Counter — instant word/character count and reading time',
        'Password Generator — strong, unique passwords in one click',
        'Color Picker — HEX, RGB, and HSL values for any colour',
        'Image Compressor — smaller image files without visible quality loss',
      ]},
    ],
  },
