...
const TOOLS = {
  ...
  'fd-calculator':               { title: 'FD Calculator — Fixed Deposit & RD Calculator India | AWE-OS',             description: 'Calculate FD maturity amount and TDS. Compare FD rates across SBI, HDFC, ICICI, Axis, Kotak and Post Office. Free online FD & RD calculator.' },
  'sip-calculator':              { title: 'SIP Calculator — Free SIP & Mutual Fund Return Calculator India | AWE-OS', description: 'Calculate SIP returns, lumpsum growth and goal-based SIP for Indian mutual funds. Compare returns at 8% 12% 15% 18% with charts.' },
