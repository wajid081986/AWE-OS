...
const TOOLS = {
  ...
  'fd-calculator':               { title: 'FD Calculator — Fixed Deposit Returns with Quarterly Interest | AWE-OS',    description: 'Calculate FD maturity amount with monthly, quarterly or yearly interest. Compare SBI, HDFC, ICICI FD rates. Free online FD calculator India.' },
  'sip-calculator':              { title: 'SIP Calculator India — Monthly Investment Returns Calculator | AWE-OS',    description: 'Calculate SIP returns for any mutual fund. Compare 8%, 12%, 15% returns. Lumpsum + SIP calculator free. No signup needed.' },
  ...
  'bmi-calculator':              { title: 'BMI Calculator India — Check Healthy Weight (kg/cm) Free | AWE-OS',   description: 'Calculate your BMI in kg/cm or ft/lb. Uses ICMR Indian standards for Indians. Get healthy weight range and BMI category free. No signup needed.' },
  ...
  'qr-code-generator':           { title: 'QR Code Generator Free — UPI, WhatsApp, Business Cards India | AWE-OS', description: 'Generate QR codes free for UPI payment, WhatsApp, URL, text and business cards. Download as PNG instantly. No signup, works in browser.' },
  'image-compressor':            { title: 'Image Compressor — Compress JPG, PNG Free Online India | AWE-OS',    description: 'Compress JPG, PNG and WEBP images free online. Reduce file size without losing quality. No upload to server, works in browser. Free, no signup.' },
  ...
  'contract-generator':          { title: 'Contract Generator — Free Indian Freelance Contract Maker | AWE-OS',   description: 'Generate professional NDA, Service Agreement and Employment contracts for Indian freelancers. GST/TDS compliance check and instant PDF download.' },
